...
cap_send = cv2.VideoCapture('v4l2src device=/dev/video0 ! video/x-raw,framerate=20/1,width=320,height=240 ! videoscale ! videoconvert ! appsink', cv2.CAP_GSTREAMER)
...
# works
#out_send = cv2.VideoWriter('appsrc ! videoconvert ! x264enc tune=zerolatency bitrate=500 speed-preset=superfast ! rtph264pay ! udpsink host=192.168.1.23 port=5000',cv2.CAP_GSTREAMER,0, 20, (320,240), True)

out_send = cv2.VideoWriter('appsrc ! videoconvert ! video/x-raw,format=I420 ! omxh264enc ! video/x-h264,profile=baseline,target-bitrate=300000 ! rtph264pay ! udpsink host=192.168.1.23 port=5000',cv2.CAP_GSTREAMER,0, 20, (320,240), True)
...
#out_send = cv2.VideoWriter('appsrc ! videoconvert ! video/x-raw,format=YUY2,width=320,height=240,framerate=30/1 ! omxh264enc ! video/x-h264,profile=baseline ! rtph264pay name=pay0 ! udpsink host=192.168.1.5 port=5000',cv2.CAP_GSTREAMER,0,30,(320,240),True);
